...
![An array with room for 10 elements](./Assets/array.png)
...
![Appending a new element](./Assets/append.png)

Looking up by index is also quick and easy:

![Indexing the array](./Assets/indexing.png)
...
![Insert requires a memory copy](./Assets/insert.png)
...
![Delete also requires a memory copy](./Assets/delete.png)
...
![Deleting just means copying one element](./Assets/delete-no-copy.png)
